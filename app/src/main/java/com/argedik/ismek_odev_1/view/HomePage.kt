...
import com.argedik.ismek_odev_1.adapter.HomePageRecyclerAdapter
...
class HomePage : AppCompatActivity() {
    ...
    private lateinit var homePageAdapter: HomePageRecyclerAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homePageAdapter= HomePageRecyclerAdapter(postArrayList)
